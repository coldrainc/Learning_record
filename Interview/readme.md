...
- 自我介绍
    您好，我叫陈雨寒，今年22岁， 是江西财经大学软件工程专业2020届毕业的一名本科生，
    从接触前端开始到现在已经有三年时间了，真正打算从事前端是大二的时候开始的，学校主要修的java，也有修一些前端相关的课程，
    平常在做项目的时候也要做前端的东西，然后慢慢的对前端感兴趣，自己有做过几个前端的项目，自己喜欢学习有关于前端的技术，目前是在前端岗位上实习，并且参与了项目的开发，主要用的技术栈是react。
    刚毕业的这一两年希望能专注于技术的提高，和适应良好的工作流程，锻炼好实践能力，结合公司的产品需求，
    当然学习还有一些不断萌发的新技术
    前端开发处于一个猛烈发展的阶段，现在可以说大部分的网站都在关注前端，前端是直接接触用户的部分
    很多技术的实现都要通过前端，怎么把这部分做好是非常具有挑战性的事情。可能四五年前很多人都还在标准的实现上摸索，而现在有一个大家都朝着标准走的大方向，就能够更好的坚持，更好的专注，把前端技术做得更强大。
    我做过小程序的项目和react项目,
    也可以说尊重企业的薪资，相信企业会给与一个合适的薪资。
- 有什么问题问我
  你们公司现在用的技术大概是什么
...
- HR面
  公司是否有针对技术、行业或商务方面的培训制度”、“平时是否有团建交流活动”
  “这个职位未来的发展空间”
  如果能够去你们公司主要是做什么
  司或我的上司如何对员工进行绩效考评？我的汇报线是怎么样的？
  公司主要的一些业务  
  对我们公司的一些看法，我觉的公司的一个氛围很不错，大部分都是年轻人，感觉能够有一个好的发展
- 对前端的一些看法
...
- js
  - 一个页面从输入 URL 到页面加载完的过程中都发生了什么事情？越详细越好
    ...
    7. 渲染页面，构建DOM树
      浏览器解析渲染呈现给用户， 解析和渲染，渲染前构建DOM树和CSSDOM
  ...
  - xss和csrf
    ...
    - csrf (跨站请求伪造)
      ...
      例如当你登录银行的时候，不小心点击了一些危险的链接，由于你处于银行网站登录状态
      防御：
...
- git
  ...
  自己做过的东西
    ...
    react项目
      主要将路由的问题 egg + typescript + 跨域问题
    公司的小程序
      主要是根据产品的要求对一些功能做一些迭代，一个问卷类型的小程序
    公司的项目
      模块化开发， 自己负责其中一些模块的开发
    自己做过的项目，必须完全了解各方面
    确保在你所做的项目中，能够清楚的说出每个细节，如果你用到了某些技术比如v-router 那你至少要说得出针对于他的几种配置以及你在项目中是如何使用的
  笔试的时候注意边界值， 特别是输入的值可能为不符合要求的，要做判断
  https 在进行握手的时候使用的是非对称加密，当握手完成后使用对称加密进行数据传输
